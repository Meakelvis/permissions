...
<div class="container-fluid">
    <form action="{{ route('applications.store') }}" method="post" class="mx-auto" autocomplete="off">
        @csrf
        <table class="table table-bordered border-dark">
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select class="form-control form-control-sm @error('purpose')border border-danger @enderror " name="purpose" id="purpose" value="{{ old('purpose') }}">
