...
<html lang="en">
    ...
    <body>
        <div class="container-fluid">
            ...
            <p style="color: red"><strong>GOU/2021/MOWT/{{ \Carbon\Carbon::parse($application->created_at)->month }}/{{ 1000+$application->id }}</strong></p>
            <p style="margin-top: -15px">{{ \Carbon\Carbon::parse($application->valid_from)->format('d/m/Y')}}</p>
            <h4 style="font-weight: bold; text-align:center;  font-size:large">SPECIAL CLEARANCE: {{ Str::upper($application->purpose) }}</h4>
            ...
            <table class="table table-bordered border-dark mt-4">
                <tbody>
                    <tr>
                        ...
                        <td rowspan="2" class="title">{{ $application->from }}</td>
                    </tr>
                    <tr>
                        <td class=" title"><strong>Title/Occupation</strong></td>
                        <td class="title">{{ $application->title }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="title">
                            {{
                            \Carbon\Carbon::parse($application->date_of_application)->format('d/m/Y')}}
                        </td>
                        <td class=" title"><strong>To</strong></td>
                        <td class="title">{{ $application->to }}</td>
                    </tr>
                    <tr>
                        <td class=" title">
                            <strong>Purpose of the Travel</strong>
                        </td>
                        <td class="title" colspan="4">{{ $application->purpose }}</td>
                    </tr>
                    <tr>
                        <td class=" title" colspan="3">
                            <strong>Vehicles accepted for this permit:</strong>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="title">{{ $vehicle->vehicle_no }}</td>
                        <td class="title" colspan="2">{{ $vehicle->driver_name }}</td>
                        <td class="title">{{ $vehicle->no_of_occupants }}</td>
                    </tr>
                    @endforeach
                    <tr>
                        ...
                        <td class="title" colspan="3">
                            {{
                            \Carbon\Carbon::parse($application->valid_from)->format('d/m/Y')}}
                            - {{
                            \Carbon\Carbon::parse($application->valid_to)->format('d/m/Y')}}
                        </td>
                    </tr>
                    <tr>
